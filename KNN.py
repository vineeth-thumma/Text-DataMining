...
def writePredictionsToCSV(mlb,neigh,testx):
    bodyclassknn = open('bodyclassknn.csv','w+')
    writer1 = csv.writer(bodyclassknn)
...
#writePredictionsToCSV(mlb,neigh,testx)         #Write the prredictions to the file
#print neigh.predict(testx)                     #Print the predictions in the system output
print neigh.score(testx,transformedY[lenx:])    #print the accuracy of the predictor in the system output
